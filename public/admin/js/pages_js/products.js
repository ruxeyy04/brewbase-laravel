...
$(document).on('click', '.addProd', function() {
  ...
  var table = $('#products').DataTable({
    "ajax": {
      "url": url+"api/admin/getProductData",
      "type": "GET",
      "dataType": "json",
      "dataSrc": "data"
    },
  ...
  $(document).on('click', '.updateProd', function () {
    ...
    $.ajax({
      type: "POST",
      url: url+ "api/admin/updateViewProduct",
...
function setProd(stat,prod) {
  $.ajax({
    type: "POST",
    url: url+"api/admin/updateProductStatus",
  ...
  let id = prodid
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
              type: "POST",
              url: url+"api/admin/deleteProduct",
              data: {delProd: id},
              dataType: "json",
              success: function (res) {
                Swal.fire(
