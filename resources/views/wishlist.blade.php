...
<body>
    ...
    <div class="body_wrap">
        ...
        <main>
            ...
            <section class="breadcrumb_section text-uppercase" style="background-image: url(img/headerall.png)">
                <div class="container">
                    <h1 class="page_title text-black wow fadeInUp" data-wow-delay=".1s">wishlist</h1>
            ...
            <!-- wishlist_section - start
    ================================================== -->
            <section class="wishlist_section sec_ptb_120 bg_default_gray">
                <div class="container">
                                    ...
                                    <td>
                                        <div class="wishlisttable_product_item">
                                            <div class="item_image" style="width: 70px;">
                                                <img src="productimg/product-6270bed9085342.27173677.png" alt="image_not_found">
                                            </div>
                                            <button type="button" class="remove_btn"><i class="fa fa-times"></i></button>
                                            <h3 class="item_title">Almond Coffee Tea</h3>
                                        </div>
                                    </td>
                                    <td><span class="price_text1">₱ 19,00</span></td>
                                    <td><span class="price_text2">April 1, 2023</span></td>
                                    <td><button class="btn btn_primary p-3"><i class="fa-solid fa-cart-plus" style="font-size: 1.5rem;"></i></button></td>
                                </tr>
                            </tbody>
                        </table>
    ...
    <script src="js/pages_js/wishlist.js"></script>
    <!-- END Script -->
</body>
