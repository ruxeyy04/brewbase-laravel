...
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    ...
    <title>BrewBase | Admin - Transactions</title>
...
<body>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-hover" id="transactions" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Payment ID</th>
                                                <th>Customer</th>
    ...
    <script src="{{ asset('admin/js/pages_js/transactions.js') }}"></script>
