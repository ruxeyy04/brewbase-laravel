...
<body>
        ...
        <div id="body">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            <div class="nav-dropdown">
                                <a href="#" id="nav2" class="nav-link dropdown-toggle text-secondary" data-toggle="dropdown" aria-expanded="false">
                                    <i class="fa fa-user"></i> <span id="fullname"></span> <i style="font-size: .8em;" class="fa fa-caret-down"></i>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right nav-link-menu">
                                    <ul class="nav-list">
                                        <li><a href="/userprofile" class="dropdown-item"><i class="fa fa-address-card"></i>
                                                Profile</a></li>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        @php
                            $summaryValues = app('App\Http\Controllers\admin\AdminController')->summaryValues()->getOriginalContent();
                        @endphp
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number totalOrder">{{ $summaryValues['totalOrders'] }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number totalRevenue">{{ $summaryValues['totalRevenue'] }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                ...
                                                <span class="number totalCustomer">{{ $summaryValues['totalCustomers'] }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="icon-big text-center">
                                                <i class="orange fas fa-box-open"></i>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="detail">
                                                <p class="detail-subtitle">Total Products</p>
                                                <span class="number totalProduct">{{ $summaryValues['totalProducts'] }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="content">
                                            <div class="head">
                                                ...
                                                <p class="text-muted">Current Year Annual Sales</p>
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="content">
                                            <div class="head">
                                                ...
                                                <p class="text-muted">Current Year Orders Data</p>
                                            </div>
                                            <div class="canvas-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">Customer List Overview</div>
                                <div class="card-body table-responsive">
                                    ...
                                    <table class="table table-hover dataTables_wrapper dt-bootstrap5 no-footer" id="dashboard-users" width="100%">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Customer</th>
    ...
    <script src="{{ asset('admin/js/pages_js/home.js') }}"></script>
