...
<body>
    ...
    ================================================== -->
            <section class="breadcrumb_section text-uppercase" style="background-image: url(img/headerall.png)">
                <div class="container">
                    <h1 class="page_title text-black wow fadeInUp" data-wow-delay=".1s">Products</h1>
      ...
      ================================================== -->
        ...
        ================================================== -->
            ...
            <section class="shop_section sec_ptb_120 bg_default_gray">
                <div class="container">
                    <ul class="cattt filters-button-group style_3 ul_li_center wow fadeInUp" data-wow-delay=".1s">
                    </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="shop_filter_tags wow fadeInUp" data-wow-delay=".1s">
                                    <h4 class="item_title text-uppercase">Popular Categories</h4>
                                    <ul class="ul_li" style="cursor: default;">
                                        <li><a>Frappe</a></li>
                    ...
                    <div class="shop_filter_grid grid wow fadeInDown" data-wow-delay=".3s">
    ...
    <script src="js/pages_js/products.js"></script>
    <!-- END Script -->
</body>
